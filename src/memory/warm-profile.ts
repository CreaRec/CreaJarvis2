...
export function buildSessionInstructions(
  ...
  return [
    ...
    "Dates are YYYY-MM-DD in the user timezone. Call get_current_time before relative dates.",
    "«Что сегодня / завтра / на пятницу?» → plan_get. Range overview → plan_get with from/to.",
    ...
    "After changes, confirm briefly with the date and item list from the tool result.",
    "",
    "Live information:",
